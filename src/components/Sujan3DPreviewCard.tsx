...
const SvgTag = () => (
  <svg className="svg-icon" style={{ color: '#2563eb', width: 20, height: 20, fill: 'none', stroke: 'currentColor', strokeWidth: 2.5, strokeLinecap: 'round', strokeLinejoin: 'round' }} viewBox="0 0 24 24"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>
);
...
export const Sujan3DPreviewCard: React.FC<Sujan3DPreviewCardProps> = ({
  ...
  return (
    <div>
      ...
      >
        {/* Avaturn.me 3D Studio Stage Background */}
        ...
        >
          ...
          <span className="text-[0.75rem] font-bold ml-1">Studio</span>
        </button>
