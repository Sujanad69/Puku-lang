    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-[#f4f5f8] overflow-hidden animate-in fade-in duration-200">
          ...
          return (
            <button
              ...
              className={`shrink-0 rounded-full px-4 py-2 text-xs font-extrabold transition-all active:scale-95 ${
                isActive
                  ? 'bg-[#58cc02] text-white shadow-md shadow-green-500/20'
      ...
      <div className="flex-1 overflow-y-auto p-4 max-w-md mx-auto w-full space-y-4">
        <div className="rounded-3xl border border-black/5 bg-white p-6 shadow-sm space-y-4">
          <div className="flex items-center gap-2 text-[#58cc02] font-black text-xl">
              ...
              <div className="space-y-3">
                ...
                {[
                  ...
                  <div
                    ...
                    className="flex items-center justify-between rounded-2xl border border-black/5 bg-slate-50 p-4 cursor-pointer hover:bg-green-50 transition-colors"
                  >
                    <div>
                    ...
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#58cc02] text-white shadow-sm">
